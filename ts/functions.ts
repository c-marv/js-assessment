const functionsAnswers = {
   ...
   */
  argsAsArray: function (fn: Function, arr: any[]): any {
    return fn(...arr);
  },
   ...
   */
  functionFunction: function (str: string): Function {
    return (anotherStr: string) => `${str}, ${anotherStr}`;
  },
};
